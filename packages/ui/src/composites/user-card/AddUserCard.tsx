...
export function AddUserCard({ onClick, disabled }: AddUserCardProps) {
  return (
    <button
      ...
      onClick={onClick}
      disabled={disabled}
      className="group flex flex-col justify-center items-center h-64 p-6 rounded-xl border-2 border-dashed border-gray-300 hover:border-blue-500 hover:bg-blue-50/30 transition-all text-center focus:outline-none focus:ring-4 focus:ring-blue-50"
    >
