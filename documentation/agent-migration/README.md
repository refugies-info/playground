...
5. **The deployed staging schema is behind the repository migration chain.** The 22/09/2026 audit found 73 applied migrations versus 93 committed files. Reconcile and re-audit the target database before adding Agent SDK persistence migrations.
