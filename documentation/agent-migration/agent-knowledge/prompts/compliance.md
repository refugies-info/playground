---
description: Bloc de prompt 'compétence conformité éditoriale' exporté depuis Letta Cloud (workspace template system/compétence_conformité_éditoriale_di) — règles de conformité injectées dans l'agent.
audience: agent
title: compliance
type: letta-block-export
origin: letta-cloud
letta-label: "system/compétence_conformité_éditoriale_di"
length: 5284
source: "Exported from Letta Cloud — agent agent-bd542fe1-c8d9-4f3d-bcbb-cfc2f750c9af, block `system/compétence_conformité_éditoriale_di`, 2026-06-15"
