---
description: Bloc de prompt 'metadata_schema' exporté depuis Letta Cloud (workspace template system/metadata_schema) — schéma de métadonnées de référence pour l'agent.
audience: agent
title: metadata-schema
type: letta-block-export
origin: letta-cloud
letta-label: "system/metadata_schema"
length: 4760
source: "Exported from Letta Cloud — agent agent-bd542fe1-c8d9-4f3d-bcbb-cfc2f750c9af, block `system/metadata_schema`, 2026-06-15"
