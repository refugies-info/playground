---
description: Guide d'annotation pour l'agent transformateur Réfugiés.info exporté depuis Letta Cloud — conventions de tagging et d'enrichissement sémantique.
audience: agent
chunks_embedded: 15
