---
description: "Table de mapping des champs Réfugiés.info vers les champs RCO exporté depuis Letta Cloud (Ressources: ressources_metadatas) — référence pour la transformation XML → fiche."
audience: agent
chunks_embedded: 11
