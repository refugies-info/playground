-- Migration: Add ingestion_word_count to workflows_enriched view (RI-1172)
--
-- Adds a word count column computed from ingestion_records.markdown,
-- stripping YAML frontmatter before counting whitespace-separated tokens.
-- Enables the "Mots" column with server-side sorting on /documents.
--
