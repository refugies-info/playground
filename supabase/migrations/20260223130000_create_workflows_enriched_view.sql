-- Migration: Create workflows_enriched view
-- This view combines workflow data with computed statuses and presentation metadata
-- for simplified querying and filtering.
...
SELECT
    ...
    CASE
        ...
        WHEN w.compliance_status = 'compliant' THEN 'to_process'::text
        ELSE NULL
    ...
    CASE
        ...
        WHEN w.compliance_status = 'non_compliant' THEN 'archived'::text
        ELSE NULL
