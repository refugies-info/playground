-- Migration: Refine workflow_ingestion_metadata view with Coalesce Date Logic
-- 1. Try user requested path: session -> periode -> debut
-- 2. Fallback to regex extraction from description
...
-- We only care about workflows with ingestion records for this view now
